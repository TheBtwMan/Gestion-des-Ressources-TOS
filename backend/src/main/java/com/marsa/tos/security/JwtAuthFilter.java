...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            String matricule = jwtService.extractUsername(token);
            ...
            // Token invalide ou expiré : la requête continue non authentifiée, Spring Security la rejettera si nécessaire.
        }
